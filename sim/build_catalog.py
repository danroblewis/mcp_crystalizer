"""Build catalog/entities.yaml from the sim world. In production this is dumped from the real MCP servers
(Jira projects/components, Slack channels, PagerDuty services, Prometheus label values, CODEOWNERS)."""
import json, yaml
from pathlib import Path

ROOT = Path(__file__).resolve().parent.parent
w = json.loads((ROOT / "sim/data/world.json").read_text())
services = {}
...
(ROOT / "catalog/entities.yaml").write_text(yaml.safe_dump(out, sort_keys=False))
